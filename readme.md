...
| [Azure CLI](https://learn.microsoft.com/en-us/cli/azure/)  | |  <img align="right" src="https://img.shields.io/badge/-azure-blue" alt="Azure"> | Cloud Operations, Azure, Scripting, DevOps | Azure cLI to access, and modify all the services  and resources in the Azure Cloud Ecosystem.|
